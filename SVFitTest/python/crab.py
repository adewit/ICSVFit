...
config.JobType.inputFiles = [os.environ['CMSSW_BASE']+'/src/ICSVFit/SVFitTest/FrameworkJobReport.xml', os.environ['CMSSW_BASE']+'/bin/'+os.environ['SCRAM_ARCH']+'/SVFitTest']
...
config.Data.outLFNDirBase='/store/user/adewit/SVFIT/'
